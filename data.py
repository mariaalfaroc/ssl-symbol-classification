...
if __name__ == "__main__":
    ...
    cv2.imwrite(f"{CHECK_DIR}/xa0.jpg", cv2.cvtColor(255*xa[0].permute(1, 2, 0).numpy(), cv2.COLOR_RGB2BGR))
    cv2.imwrite(f"{CHECK_DIR}/xb0.jpg", cv2.cvtColor(255*xb[0].permute(1, 2, 0).numpy(), cv2.COLOR_RGB2BGR))
    save_image(xa[0], f"{CHECK_DIR}/xa0_torch.jpg")
    save_image(xb[0], f"{CHECK_DIR}/xb0_torch.jpg")
    save_image(make_grid(xa, nrow=4), f"{CHECK_DIR}/xa.jpg")
    save_image(make_grid(xb, nrow=4), f"{CHECK_DIR}/xb.jpg")
    ...
    print(xi.shape)
    print(yi.shape)
    cv2.imwrite(f"{CHECK_DIR}/xi0.jpg", cv2.cvtColor(255*xi[0].permute(1, 2, 0).numpy(), cv2.COLOR_RGB2BGR))
    save_image(xi[0], f"{CHECK_DIR}/xi0_torch.jpg")
